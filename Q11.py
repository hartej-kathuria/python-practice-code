# In certain applications of the queue, it is common to repeatedly dequeue an element, process it in some 
# way, and then immediately enqueuer the same element. Modify ArrayQueue implementation to 
